module github.com/openshift-kni/resource-topology-exporter
...
require (
	...
	github.com/k8stopologyawareschedwg/resource-topology-exporter v0.2.6-0.20211104082133-eabd0b87af8c
